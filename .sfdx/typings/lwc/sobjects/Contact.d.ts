...
declare module "@salesforce/schema/Contact.lwrfileupload__Level__c" {
  const lwrfileupload__Level__c:string;
  export default lwrfileupload__Level__c;
}
declare module "@salesforce/schema/Contact.lwrfileupload__Languages__c" {
  const lwrfileupload__Languages__c:string;
  export default lwrfileupload__Languages__c;
}
