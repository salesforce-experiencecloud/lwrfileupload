...
declare module "@salesforce/schema/Opportunity.lwrfileupload__DeliveryInstallationStatus__c" {
  const lwrfileupload__DeliveryInstallationStatus__c:string;
  export default lwrfileupload__DeliveryInstallationStatus__c;
}
declare module "@salesforce/schema/Opportunity.lwrfileupload__TrackingNumber__c" {
  const lwrfileupload__TrackingNumber__c:string;
  export default lwrfileupload__TrackingNumber__c;
}
declare module "@salesforce/schema/Opportunity.lwrfileupload__OrderNumber__c" {
  const lwrfileupload__OrderNumber__c:string;
  export default lwrfileupload__OrderNumber__c;
}
declare module "@salesforce/schema/Opportunity.lwrfileupload__CurrentGenerators__c" {
  const lwrfileupload__CurrentGenerators__c:string;
  export default lwrfileupload__CurrentGenerators__c;
}
declare module "@salesforce/schema/Opportunity.lwrfileupload__MainCompetitors__c" {
  const lwrfileupload__MainCompetitors__c:string;
  export default lwrfileupload__MainCompetitors__c;
}
