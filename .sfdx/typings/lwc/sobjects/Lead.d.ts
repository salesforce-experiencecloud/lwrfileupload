...
declare module "@salesforce/schema/Lead.lwrfileupload__SICCode__c" {
  const lwrfileupload__SICCode__c:string;
  export default lwrfileupload__SICCode__c;
}
declare module "@salesforce/schema/Lead.lwrfileupload__ProductInterest__c" {
  const lwrfileupload__ProductInterest__c:string;
  export default lwrfileupload__ProductInterest__c;
}
declare module "@salesforce/schema/Lead.lwrfileupload__Primary__c" {
  const lwrfileupload__Primary__c:string;
  export default lwrfileupload__Primary__c;
}
declare module "@salesforce/schema/Lead.lwrfileupload__CurrentGenerators__c" {
  const lwrfileupload__CurrentGenerators__c:string;
  export default lwrfileupload__CurrentGenerators__c;
}
declare module "@salesforce/schema/Lead.lwrfileupload__NumberofLocations__c" {
