...
declare module "@salesforce/schema/Account.lwrfileupload__CustomerPriority__c" {
  const lwrfileupload__CustomerPriority__c:string;
  export default lwrfileupload__CustomerPriority__c;
}
declare module "@salesforce/schema/Account.lwrfileupload__SLA__c" {
  const lwrfileupload__SLA__c:string;
  export default lwrfileupload__SLA__c;
}
declare module "@salesforce/schema/Account.lwrfileupload__Active__c" {
  const lwrfileupload__Active__c:string;
  export default lwrfileupload__Active__c;
}
declare module "@salesforce/schema/Account.lwrfileupload__NumberofLocations__c" {
  const lwrfileupload__NumberofLocations__c:number;
  export default lwrfileupload__NumberofLocations__c;
}
declare module "@salesforce/schema/Account.lwrfileupload__UpsellOpportunity__c" {
  const lwrfileupload__UpsellOpportunity__c:string;
  export default lwrfileupload__UpsellOpportunity__c;
}
declare module "@salesforce/schema/Account.lwrfileupload__SLASerialNumber__c" {
  const lwrfileupload__SLASerialNumber__c:string;
  export default lwrfileupload__SLASerialNumber__c;
}
declare module "@salesforce/schema/Account.lwrfileupload__SLAExpirationDate__c" {
  const lwrfileupload__SLAExpirationDate__c:any;
  export default lwrfileupload__SLAExpirationDate__c;
}
