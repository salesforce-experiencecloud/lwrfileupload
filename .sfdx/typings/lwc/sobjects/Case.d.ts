...
declare module "@salesforce/schema/Case.lwrfileupload__EngineeringReqNumber__c" {
  const lwrfileupload__EngineeringReqNumber__c:string;
  export default lwrfileupload__EngineeringReqNumber__c;
}
declare module "@salesforce/schema/Case.lwrfileupload__SLAViolation__c" {
  const lwrfileupload__SLAViolation__c:string;
  export default lwrfileupload__SLAViolation__c;
}
declare module "@salesforce/schema/Case.lwrfileupload__Product__c" {
  const lwrfileupload__Product__c:string;
  export default lwrfileupload__Product__c;
}
declare module "@salesforce/schema/Case.lwrfileupload__PotentialLiability__c" {
  const lwrfileupload__PotentialLiability__c:string;
  export default lwrfileupload__PotentialLiability__c;
}
